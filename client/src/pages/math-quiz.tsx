...
import { SquareRadical, Trophy, RefreshCw, ArrowRight } from 'lucide-react';
import { mathQuizData, QuizQuestion } from '@/data/quiz-data';
...
export default function MathQuiz({ language }: MathQuizProps) {
  ...
  const getLevelColor = (level: Level) => {
    switch (level) {
      case 'elementary': return 'bg-red-100 hover:bg-red-200 text-red-800';
      case 'middle': return 'bg-red-200 hover:bg-red-300 text-red-800';
      case 'high': return 'bg-red-300 hover:bg-red-400 text-red-800';
      case 'university': return 'bg-red-400 hover:bg-red-500 text-white';
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">あなたの学習レベルに合わせて問題を選んでください</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="text-sm opacity-80">基本的な四則演算</div>
              </Button>
              ...
              >
                ...
                <div className="text-sm opacity-80">代数・幾何の基礎</div>
              </Button>
              ...
              >
                ...
                <div className="text-sm opacity-80">三角関数・微積分</div>
              </Button>
              ...
              >
                ...
                <div className="text-sm opacity-80">高等数学</div>
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              {t('module.math-quiz')} - {getLevelTitle(selectedLevel)}
            </div>
